...
test("the renderings carry the four things an agent needs: rate with interval, quote, file and line, what to do next", () => {
  ...
  assert.match(halted, /Stopped at 11 of 50: Your app stopped answering at turn 11 \(their side\)\. Bring your app back up/);
  const late = runText({ kind: "run", jobId: "j", status: "succeeded", played: 71, of: 71, finished: true, score: 92, findings: 6, url: "u", stopped: { after: 112, why: "your app stopped answering", side: "theirs", fix: "Bring your app back up, then run again." } });
  assert.match(late, /Score 92 of 100\. 6 findings; call findings\. Your app stopped answering at turn 112 \(their side\)\./);
  assert.doesNotMatch(late, /Stopped at/);
